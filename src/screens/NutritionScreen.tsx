...
function createStyles() {
  return StyleSheet.create({
    ...
    scannerRoot: { flex: 1, backgroundColor: '#0B0D0C' }, scannerHeader: { minHeight: 68, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.background }, scannerHeaderText: { flex: 1, alignItems: 'center', paddingHorizontal: 8 }, scannerTitle: { ...typography.title, color: colors.text }, scannerSubtitle: { ...typography.caption, color: colors.textSecondary }, torchButton: { width: 44, height: 44, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted }, torchButtonActive: { backgroundColor: colors.accent }, cameraWrap: { flex: 1, overflow: 'hidden', backgroundColor: '#050505' }, scanGuide: { ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center' }, scanFrame: { width: '78%', height: 170, borderRadius: 24, borderWidth: 2, borderColor: '#FFFFFF', justifyContent: 'center', overflow: 'hidden' }, scanLine: { height: 2, backgroundColor: colors.accent, marginHorizontal: 14 }, scanHint: { marginTop: 18, color: '#FFFFFF', fontSize: 14, fontWeight: '700', backgroundColor: 'rgba(0,0,0,0.45)', paddingHorizontal: 13, paddingVertical: 8, borderRadius: radius.pill, overflow: 'hidden' }, scannerFooter: { minHeight: 78, paddingHorizontal: 22, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, backgroundColor: colors.background }, scannerFooterText: { ...typography.caption, color: colors.textSecondary, flex: 1 }, permissionState: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 14, padding: 24, backgroundColor: colors.background }, permissionTitle: { ...typography.title, color: colors.text, textAlign: 'center' },
    overlay: { ...StyleSheet.absoluteFillObject, backgroundColor: colors.overlay }, sheetDismissZone: { minHeight: 28, alignItems: 'center', justifyContent: 'center' }, sheetHandle: { width: 38, height: 5, borderRadius: 3, backgroundColor: colors.border },
